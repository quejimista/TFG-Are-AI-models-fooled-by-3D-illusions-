...
comparable experiment (\cref{fig:fig_midas_psy_ponzo,fig:fig_psy_angle}).
...
more rigid (\cref{fig:fig_psy_ypos}).
...
\subsubsection*{A. Model Output Visualizations: Qualitative Depth Maps}
\begin{figure}[H]
  \centering
...
\subsubsection*{B. Quantitative Psychophysical Experiments visualizations.}
