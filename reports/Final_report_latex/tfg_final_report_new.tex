...
illusion (Fig. \ref{fig:ponzo}), mirroring the human tendency to interpret height-in-field as distance. V3
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\linewidth]{figures/fig_ponzo.png}
        \caption{The classical Ponzo Illusion stimulus. Two identical horizontal bars are placed within converging lines, which naturally simulate distance and a vanishing point.}
        \label{fig:ponzo}
    \end{figure}
